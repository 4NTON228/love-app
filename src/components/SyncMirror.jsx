  ...
  return (
    <div className={`sm-page${darkMode ? ' sm-dark' : ''}`}>
      <style>{`
        ...
        .sm-waiting-title {
          font-size: 16px; font-weight: 700; color: var(--ink, #1E0A10);
          margin-bottom: 6px;
        }
        ...
        .sm-match {
          ...
          animation: smFadeIn 0.4s ease both;
        }
        @keyframes smFadeIn { from { opacity: 0; transform: scale(0.96); } to { opacity: 1; transform: scale(1); } }
        ...
        .sm-answer-card {
          ...
          animation: smSlideUp 0.35s ease both;
        }
          ...
          <div className="sm-streak-bar">
            <div className="sm-streak-dots">
              {Array.from({ length: 7 }).map((_, i) => (
                <div key={i} className={`sm-streak-dot${i < streak ? ' filled' : ''}`}>
                  {i < streak ? '✦' : ''}
                </div>
              ))}
            </div>
            ...
            {bothAnswered ? (
              <>
                ...
                <div className="sm-answers">
                  <div className="sm-answer-card" style={{ animationDelay: '0s' }}>
                    <div className="sm-answer-who sm-answer-you">Ты</div>
                    <div className="sm-answer-text">{myStoredAns}</div>
                  </div>
                  <div className="sm-answer-card" style={{ animationDelay: '0.1s' }}>
